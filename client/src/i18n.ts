...
const PT: Dict = {
  ...
  'lobby.watch_tip': 'Acompanhar esta partida ao vivo. Você vê a ação, não os recursos de quem está jogando — e não pode dar ordens.',
  'lobby.watching': '👁 {n} assistindo',
  'lobby.spectate_over': 'A partida que você assistia terminou.',
  'lobby.spectate_closed': 'O anfitrião fechou a transmissão desta partida.',
  'lobby.gave_up': 'Você saiu no meio da partida — contou como derrota.',
  'spec.watching': 'Assistindo',
  'spec.badge': '👁 {n} assistindo',
  'defeat.title': 'Você foi derrotado',
  'defeat.desc': 'A batalha continua sem você. Quer ver como termina?',
  'defeat.watch': 'Assistir o resto',
  'defeat.leave': 'Voltar ao lobby',
  'spec.end_title': 'Fim da partida',
  'spec.end_surrender': '{who} desistiu — a partida terminou.',
  'spec.end_winner': '{winner} venceu a partida.',
  'spec.end_over': 'A partida terminou.',
  'spec.end_closed': 'O anfitrião encerrou a transmissão.',
  'spec.end_stay': 'Continuar olhando',
  'spec.end_leave': 'Voltar ao lobby',
  // sala
  'room.title': 'Sala',
  'room.room_n': 'Sala {id}',
  'room.mode': 'Modo:',
  ...
  'room.map': 'Mapa:',
  'room.map_open': 'Aberto',
  'room.map_open_desc': 'Mapa todo visível desde o início (padrão).',
  'room.map_closed': 'Fechado',
  'room.map_closed_desc': 'Névoa de guerra: o mapa começa escuro e revela conforme você explora.',
  'room.broadcast': 'Transmitir',
  'room.broadcast_on': 'Aberta',
  'room.broadcast_on_desc': 'Qualquer um no lobby pode assistir esta partida. Quem assiste vê a ação, mas não os recursos de ninguém, e não interfere.',
  'room.broadcast_off': 'Fechada',
  'room.broadcast_off_desc': 'Partida privada: ninguém de fora pode assistir. Fechar no meio do jogo tira quem já estava assistindo.',
  'room.bot_diff_tip': 'Clique para mudar a dificuldade do bot.',
  'room.difficulty': 'Dificuldade:',
  'room.diff_easy': 'Fácil',
  'room.diff_easy_desc': 'Passivo: só se defende (revida quando você ataca). Economia menor.',
  'room.diff_normal': 'Médio',
  'room.diff_normal_desc': 'Ataca quando junta um exército. Equilibrado (padrão).',
  'room.diff_hard': 'Difícil',
  'room.diff_hard_desc': 'Economia maior, ataca com menos tropas e sobe de era mais rápido.',
  'room.diff_expert': 'Muito difícil',
  'room.diff_expert_desc': 'Agressivo, sobe de era cedo e começa com bônus de recursos (Titã).',
  'room.ready': 'Pronto',
  ...
  'room.leave_confirm': 'Confirmar saída?',
  'room.players': 'Jogadores',
  'room.config': 'Configuração da partida',
  'room.host': 'Host',
  'room.empty_slot': 'Espaço disponível',
  'room.send': 'Enviar',
  'room.chat': 'Chat',
  ...
  'opt.room_tab': 'Sala',
  'opt.vowel_intro': 'Conecte o assistente de voz Vowel. Ao salvar, a barra aparece no topo da partida.',
  'opt.vowel_url': 'URL do Vowel',
  'opt.vowel_key': 'Chave da API',
  'opt.vowel_key_placeholder': 'Cole sua chave da API',
  'opt.vowel_key_saved': 'Chave salva nesta aba',
  'opt.vowel_key_show': 'Mostrar chave da API',
  'opt.vowel_key_hide': 'Ocultar chave da API',
  'opt.vowel_key_clear': 'Limpar chave da API',
  'opt.vowel_server_key_warning': 'Chave de servidor detectada. Use uma chave de cliente (vc_…) no navegador; chaves de servidor podem expor acesso administrativo.',
  'opt.vowel_error_copy': 'Copiar erro',
  'opt.vowel_error_copied': 'Erro copiado',
  'opt.vowel_unreachable': 'Não foi possível acessar o Vowel em {url}. Verifique a URL e se o Vowel está em execução.',
  'opt.vowel_connect': 'Conectar',
  'opt.vowel_checking': 'Verificando a conexão…',
  'opt.vowel_connected': 'Conectado · perfil {profile}',
  'opt.vowel_not_connected': 'Vowel não configurado.',
  'opt.vowel_show': 'Mostrar Vowel',
  'opt.vowel_disconnect': 'Desconectar',
  'opt.vowel_session_note': 'A chave fica somente nesta aba do navegador e é apagada ao fechá-la.',
  'opt.vowel_nag': '✦ Conectar assistente Vowel · adicionar chave da API ✦',
  'opt.close': 'Fechar',
  // fim de jogo
  ...
  'err.room_idle_closed': 'Sala encerrada por inatividade.',
  'room.team': 'Time',
  'room.team_tip': 'Time da vaga (host escolhe): — = sozinho; 1/2 = aliados do mesmo número. Aliados vencem juntos.',
  'pause.title': 'PAUSADO',
  'pause.by': '{name} pausou a partida',
  'pause.hint': 'Aperte P para continuar',
  'mini.army': 'Reunir o exército',
  ...
  'err.spectate_unavailable': 'Esta partida não está mais disponível para assistir.',
  'err.spectate_closed': 'O anfitrião desta sala não está transmitindo a partida.',
  ...
  'err.house_cap': 'Moradia no máximo ({max}): mais casas não aumentam a população.',
  ...
  'sheep.name': 'Ovelha',
  'hint.sheep': 'Chegue perto com qualquer unidade e ela vira sua; mande aldeões (botão direito) para abatê-la e virar comida.',
  // HUD — seleção
  ...
  'hud.garrison': '🛡 {n} dentro',
  'hud.eject': 'Colocar para fora (U)',
  'hud.eject_tip': 'Tira as unidades de dentro do prédio e devolve elas pro mapa.',
  // HUD — ações
  'hud.build': 'Construir',
  'hud.train': 'Treinar',
...
const EN: Dict = {
  ...
  'lobby.join': 'Join',
  'lobby.watch': 'Watch',
  'lobby.watch_tip': 'Follow this match live. You see the action, not the players’ resources — and you cannot give orders.',
  'lobby.watching': '👁 {n} watching',
  'lobby.spectate_over': 'The match you were watching has ended.',
  'lobby.spectate_closed': 'The host closed the broadcast for this match.',
  'lobby.gave_up': 'You left mid-match — it counted as a defeat.',
  'spec.watching': 'Watching',
  'spec.badge': '👁 {n} watching',
  'defeat.title': 'You have been defeated',
  'defeat.desc': 'The battle goes on without you. Want to see how it ends?',
  'defeat.watch': 'Watch the rest',
  'defeat.leave': 'Back to lobby',
  'spec.end_title': 'Match over',
  'spec.end_surrender': '{who} gave up — the match is over.',
  'spec.end_winner': '{winner} won the match.',
  'spec.end_over': 'The match is over.',
  'spec.end_closed': 'The host ended the broadcast.',
  'spec.end_stay': 'Keep looking',
  'spec.end_leave': 'Back to lobby',
  'room.title': 'Room',
  'room.room_n': 'Room {id}',
  'room.mode': 'Mode:',
  'room.mode_normal': 'Normal',
  ...
  'room.map': 'Map:',
  'room.map_open': 'Open',
  'room.map_open_desc': 'Whole map visible from the start (default).',
  'room.map_closed': 'Closed',
  'room.map_closed_desc': 'Fog of war: the map starts dark and reveals as you explore.',
  'room.broadcast': 'Broadcast',
  'room.broadcast_on': 'Open',
  'room.broadcast_on_desc': 'Anyone in the lobby can watch this match. Viewers see the action but not anyone’s resources, and cannot interfere.',
  'room.broadcast_off': 'Closed',
  'room.broadcast_off_desc': 'Private match: nobody outside can watch. Closing mid-game drops anyone already watching.',
  'room.bot_diff_tip': 'Click to change the bot difficulty.',
  'room.difficulty': 'Difficulty:',
  'room.diff_easy': 'Easy',
  'room.diff_easy_desc': 'Passive: only defends (fights back when you attack). Smaller economy.',
  'room.diff_normal': 'Medium',
  'room.diff_normal_desc': 'Attacks once it gathers an army. Balanced (default).',
  'room.diff_hard': 'Hard',
  'room.diff_hard_desc': 'Bigger economy, attacks with fewer troops and ages up faster.',
  'room.diff_expert': 'Very hard',
  'room.diff_expert_desc': 'Aggressive, ages up early and starts with a resource bonus (Titan).',
  'room.ready': 'Ready',
  ...
  'room.leave_confirm': 'Confirm leave?',
  'room.players': 'Players',
  'room.config': 'Match settings',
  'room.host': 'Host',
  'room.empty_slot': 'Open slot',
  'room.send': 'Send',
  'room.chat': 'Chat',
  ...
  'opt.room_tab': 'Room',
  'opt.vowel_intro': 'Connect the Vowel voice assistant. Once saved, its bar appears above the match.',
  'opt.vowel_url': 'Vowel URL',
  'opt.vowel_key': 'API key',
  'opt.vowel_key_placeholder': 'Paste your API key',
  'opt.vowel_key_saved': 'Key saved for this tab',
  'opt.vowel_key_show': 'Show API key',
  'opt.vowel_key_hide': 'Hide API key',
  'opt.vowel_key_clear': 'Clear API key',
  'opt.vowel_server_key_warning': 'Server key detected. Use a client key (vc_…) in the browser; server keys can expose administrative access.',
  'opt.vowel_error_copy': 'Copy error',
  'opt.vowel_error_copied': 'Error copied',
  'opt.vowel_unreachable': 'Could not reach Vowel at {url}. Check the URL and make sure Vowel is running.',
  'opt.vowel_connect': 'Connect',
  'opt.vowel_checking': 'Checking the connection…',
  'opt.vowel_connected': 'Connected · profile {profile}',
  'opt.vowel_not_connected': 'Vowel is not configured.',
  'opt.vowel_show': 'Show Vowel',
  'opt.vowel_disconnect': 'Disconnect',
  'opt.vowel_session_note': 'The key stays only in this browser tab and is cleared when the tab closes.',
  'opt.vowel_nag': '✦ Connect Vowel assistant · add API key ✦',
  'opt.close': 'Close',
  ...
  'err.room_idle_closed': 'Room closed due to inactivity.',
  'room.team': 'Team',
  'room.team_tip': 'Slot team (host sets it): — = solo; 1/2 = allies share the number. Allies win together.',
  'pause.title': 'PAUSED',
  'pause.by': '{name} paused the game',
  'pause.hint': 'Press P to resume',
  'mini.army': 'Select all military',
  ...
  'err.spectate_unavailable': 'This match is no longer available to watch.',
  'err.spectate_closed': 'This room’s host is not broadcasting the match.',
  ...
  'err.house_cap': 'Housing is maxed ({max}): more houses will not raise the population cap.',
  ...
  'sheep.name': 'Sheep',
  'hint.sheep': 'Get any unit close and it becomes yours; send villagers (right-click) to slaughter it for food.',
  ...
  'hud.garrison': '🛡 {n} inside',
  'hud.eject': 'Send them out (U)',
  'hud.eject_tip': 'Takes the units out of the building and puts them back on the map.',
  'hud.build': 'Build',
  'hud.train': 'Train',
...
const ES: Dict = {
  ...
  'lobby.join': 'Unirse',
  'lobby.watch': 'Ver',
  'lobby.watch_tip': 'Sigue esta partida en vivo. Ves la acción, no los recursos de quienes juegan, y no puedes dar órdenes.',
  'lobby.watching': '👁 {n} viendo',
  'lobby.spectate_over': 'La partida que veías terminó.',
  'lobby.spectate_closed': 'El anfitrión cerró la transmisión de esta partida.',
  'lobby.gave_up': 'Saliste a mitad de la partida — contó como derrota.',
  'spec.watching': 'Viendo',
  'spec.badge': '👁 {n} viendo',
  'defeat.title': 'Has sido derrotado',
  'defeat.desc': 'La batalla sigue sin ti. ¿Quieres ver cómo termina?',
  'defeat.watch': 'Ver el resto',
  'defeat.leave': 'Volver al lobby',
  'spec.end_title': 'Fin de la partida',
  'spec.end_surrender': '{who} se rindió — la partida terminó.',
  'spec.end_winner': '{winner} ganó la partida.',
  'spec.end_over': 'La partida terminó.',
  'spec.end_closed': 'El anfitrión cerró la transmisión.',
  'spec.end_stay': 'Seguir mirando',
  'spec.end_leave': 'Volver al lobby',
  'room.title': 'Sala',
  'room.room_n': 'Sala {id}',
  'room.mode': 'Modo:',
  'room.mode_normal': 'Normal',
  ...
  'room.map': 'Mapa:',
  'room.map_open': 'Abierto',
  'room.map_open_desc': 'Mapa entero visible desde el inicio (predeterminado).',
  'room.map_closed': 'Cerrado',
  'room.map_closed_desc': 'Niebla de guerra: el mapa empieza oscuro y se revela al explorar.',
  'room.broadcast': 'Transmitir',
  'room.broadcast_on': 'Abierta',
  'room.broadcast_on_desc': 'Cualquiera en el lobby puede ver esta partida. Quien mira ve la acción, pero no los recursos de nadie, y no interfiere.',
  'room.broadcast_off': 'Cerrada',
  'room.broadcast_off_desc': 'Partida privada: nadie de fuera puede verla. Cerrarla a mitad del juego expulsa a quien ya estaba viendo.',
  'room.bot_diff_tip': 'Haz clic para cambiar la dificultad del bot.',
  'room.difficulty': 'Dificultad:',
  'room.diff_easy': 'Fácil',
  'room.diff_easy_desc': 'Pasivo: solo se defiende (contraataca cuando lo atacas). Economía menor.',
  'room.diff_normal': 'Medio',
  'room.diff_normal_desc': 'Ataca cuando junta un ejército. Equilibrado (por defecto).',
  'room.diff_hard': 'Difícil',
  'room.diff_hard_desc': 'Economía mayor, ataca con menos tropas y sube de edad más rápido.',
  'room.diff_expert': 'Muy difícil',
  'room.diff_expert_desc': 'Agresivo, sube de edad temprano y empieza con bonus de recursos (Titán).',
  'room.ready': 'Listo',
  ...
  'room.leave_confirm': '¿Confirmar salida?',
  'room.players': 'Jugadores',
  'room.config': 'Configuración de la partida',
  'room.host': 'Host',
  'room.empty_slot': 'Espacio disponible',
  'room.send': 'Enviar',
  'room.chat': 'Chat',
  ...
  'opt.room_tab': 'Sala',
  'opt.vowel_intro': 'Conecta el asistente de voz Vowel. Al guardar, su barra aparece sobre la partida.',
  'opt.vowel_url': 'URL de Vowel',
  'opt.vowel_key': 'Clave de API',
  'opt.vowel_key_placeholder': 'Pega tu clave de API',
  'opt.vowel_key_saved': 'Clave guardada en esta pestaña',
  'opt.vowel_key_show': 'Mostrar clave de API',
  'opt.vowel_key_hide': 'Ocultar clave de API',
  'opt.vowel_key_clear': 'Borrar clave de API',
  'opt.vowel_server_key_warning': 'Se detectó una clave de servidor. Usa una clave de cliente (vc_…) en el navegador; las claves de servidor pueden exponer acceso administrativo.',
  'opt.vowel_error_copy': 'Copiar error',
  'opt.vowel_error_copied': 'Error copiado',
  'opt.vowel_unreachable': 'No se pudo acceder a Vowel en {url}. Comprueba la URL y que Vowel esté en ejecución.',
  'opt.vowel_connect': 'Conectar',
  'opt.vowel_checking': 'Comprobando la conexión…',
  'opt.vowel_connected': 'Conectado · perfil {profile}',
  'opt.vowel_not_connected': 'Vowel no está configurado.',
  'opt.vowel_show': 'Mostrar Vowel',
  'opt.vowel_disconnect': 'Desconectar',
  'opt.vowel_session_note': 'La clave permanece solo en esta pestaña y se borra al cerrarla.',
  'opt.vowel_nag': '✦ Conectar asistente Vowel · añadir clave de API ✦',
  'opt.close': 'Cerrar',
  ...
  'err.room_idle_closed': 'Sala cerrada por inactividad.',
  'room.team': 'Equipo',
  'room.team_tip': 'Equipo del puesto (lo elige el host): — = solo; 1/2 = aliados con el mismo número. Los aliados ganan juntos.',
  'pause.title': 'PAUSA',
  'pause.by': '{name} pausó la partida',
  'pause.hint': 'Pulsa P para continuar',
  'mini.army': 'Reunir el ejército',
  ...
  'err.spectate_unavailable': 'Esta partida ya no está disponible para ver.',
  'err.spectate_closed': 'El anfitrión de esta sala no está transmitiendo la partida.',
  ...
  'err.no_resources': 'Recursos insuficientes.',
  'err.house_cap': 'Alojamiento al máximo ({max}): más casas no aumentan la población.',
  ...
  'sheep.name': 'Oveja',
  'hint.sheep': 'Acércate con cualquier unidad y será tuya; envía aldeanos (clic derecho) para sacrificarla y obtener comida.',
  ...
  'hud.remaining': 'Restante: {amt} / {total} {icon}',
  'hud.garrison': '🛡 {n} dentro',
  'hud.eject': 'Sacarlos (U)',
  'hud.eject_tip': 'Saca las unidades de dentro del edificio y las devuelve al mapa.',
  'hud.build': 'Construir',
  'hud.train': 'Entrenar',
